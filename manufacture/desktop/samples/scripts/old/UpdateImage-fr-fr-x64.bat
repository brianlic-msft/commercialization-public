...
@pause
Dism /Add-Package /Image:"C:\mount\windows" /PackagePath="C:\Languages\fr-FR x64\lp.cab"
@echo. 
@echo. 
@echo **********************************************************************
@echo.
...
@pause
Dism /Add-Package /Image:"C:\mount\windows" /PackagePath="C:\Languages\fr-FR x64\Microsoft-Windows-LanguageFeatures-Basic-fr-fr-Package.cab"
Dism /Add-Package /Image:"C:\mount\windows" /PackagePath="C:\Languages\fr-FR x64\Microsoft-Windows-LanguageFeatures-Speech-fr-fr-Package.cab"
@echo. 
@echo. 
@echo **********************************************************************
@echo.
